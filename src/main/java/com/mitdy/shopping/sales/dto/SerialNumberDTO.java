...
public class SerialNumberDTO implements Serializable {
	...
	public String toString() {
		return "SerialNumberDTO [serialNumberId=" + serialNumberId + ", currentSerialNumber=" + currentSerialNumber
				+ ", generatedSerialNumber=" + generatedSerialNumber + ", serialNumberDate=" + serialNumberDate + "]";
	}
